...
//   core_version=<new @zbynekstara-test/core version>
//   core_changed=<true|false>   (is @zbynekstara-test/core in the release plan?)
...
const DOCUMENTED_PACKAGES = ['@zbynekstara-test/core', '@zbynekstara-test/dep'];
...
const core = versionByPkg.get('@zbynekstara-test/core');
const coreVersion = core ?? packages.packages.find((p) => p.packageJson.name === '@zbynekstara-test/core').packageJson.version;
const coreChanged = versionByPkg.has('@zbynekstara-test/core');
