...
// Any other publishable packages are still versioned & published by the pipeline,
// but are intentionally NOT listed in the human-facing CHANGELOG.
...
function parseArgs(argv) {
    const args = { dryRun: false, date: null, changelog: 'CHANGELOG', releaseNotes: 'RELEASE_NOTES.md', repo: 'zbynekstara/zbynekstara-npm-test' };
